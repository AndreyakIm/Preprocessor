...
namespace PreprocessorLib
{
    public partial class ProjectForm : Form
    {
        ...
        public ProjectForm()
        {
            ...
            this.currentFullModel.settings.ShowGrid = false;
        ...
        public void SetMaterialsClick()
        {
            // проверяем, не открыта ли форма нагрузок
            if ((this.forcesForm != null && this.forcesForm.IsHandleCreated)) return;
            if ((this.setMaterialsForm != null && this.setMaterialsForm.IsHandleCreated))
            {
                //this.setMaterialsForm.Visible = true;
            //    this.setMaterialsForm.TopLevel = true;
                return; }
            ...
            //     this.setMaterialsForm.TopLevel = true;
            //  this.setMaterialsForm.Activate();
            //this.TopLevel = false;
        }
 ...
 /*       private void showFE_CheckedChanged(object sender, EventArgs e)
        ...
        */
        ...
        private void forceScale_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                k = (25 - val + 1);
                PixelPerNewton = startPixelPerNewton / (k*10000);
            }
            ReDrawAll(true);
        }
...
//            this.showFE.Checked = true;
        ...
        private void scaleField_TextChanged(object sender, EventArgs e)
        {

        }

        private void forceScale_Scroll(object sender, EventArgs e)
        {
